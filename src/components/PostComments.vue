    ...
    <div class="comments-container">
      ...
      <div class="comments">
        <div class="user-post__details comments__user-details">
          <div class="user-post__acc-image"><img src="src/assets/user__image.png"></div>
          <div class="user-post__username">username</div>
          <svg class="user-post__details-additionally" fill="#262626" height="24" role="img" viewBox="0 0 24 24" width="24"><circle cx="12" cy="12" r="1.5"></circle><circle cx="6" cy="12" r="1.5"></circle><circle cx="18" cy="12" r="1.5"></circle>
          </svg>
        </div>

        <div class="comments__content">
          <div class="comments__content-comment">
            <div class="comments__content-image"><img src="src/assets/user__image.png"></div>
            <div class="comments__content-wrapper">
              <div class="comments-user">
                <div class="comments-user__details">
                  <div class="comments-user__name">{{ post.username }}</div>
                  <div class="comments-user__text">some text</div>
                </div>
                <div class="comments-user__info">
                  <div class="comments-user__data">2 ч.</div>
                  <div class="comments-user__likes">Нравится: <span>{{ post.likes }}</span></div>
